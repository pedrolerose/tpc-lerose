<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EnvioMailPass.aspx.cs" Inherits="Web.EnvioMailPass" %>
     ...
     <div class="row" style="margin-bottom: 50px; margin-top: 50px; justify-content: center">
        <div class="card col-md-6" style="width: 25%;">
            <div class="card-body" style="margin-left: 20px;justify-content: center">
                <h1 class="card-title">Le enviamos un mail para cambiar su pass</h1>
