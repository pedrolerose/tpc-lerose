...
<asp:Content runat="server" ID="Listado" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <h1 style="margin-left: 50px; margin-top: 20px;" class="text-white">Lista Articulos</h1>
            ...
            <div class="card" style="background-color: black;">
                ...
                <div class="card-body">
                    ...
                    <div class="row" style="margin: 10px; height: 25px;">
                        <p class="card-text text-white">$ <% = decimal.Round(item.Precio, 2, MidpointRounding.AwayFromZero) %></p>
                    </div>

                    <div class="row" style="margin: 10px; height: 38px;">
                        <a href="Listado.aspx?idart=<% = item.Id.ToString() %>" class="btn btn-dark border border-white">
